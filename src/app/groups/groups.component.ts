...
saveNewGroup(updateGroup : Group): void {
     ...
     this.getAllGroups();  
    //this.groupsService.createGroup(updateGroup).toPromise() this.getAllGroups );
 }

 deleteGroup(deletingGroup : Group) : void{
   this.groupsService.deleteGroup(deletingGroup).subscribe();
   this.getAllGroups();
 }
